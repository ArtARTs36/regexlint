...
RUN GOOS=linux CGO_ENABLED=1 go build -ldflags="-s -w -extldflags=-static -X 'main.Version=${APP_VERSION}' -X 'main.BuildDate=${BUILD_TIME}'" -o /go/bin/regexlint /go/src/github.com/artarts36/regexlint/cmd/main.go
